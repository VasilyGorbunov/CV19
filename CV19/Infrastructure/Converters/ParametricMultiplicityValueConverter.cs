...
{
  public class ParametricMultiplicityValueConverter: Freezable, IValueConverter
  {
    ...
    protected override Freezable CreateInstanceCore() => new ParametricMultiplicityValueConverter
    {
      Value = Value
    };
  }
